...
int main() {
	...
	riffoser_track_writeogg(track,"example8l.ogg",48000,128);
	...
	riffoser_track_writeogg(track,"example8r.ogg",48000,128);
	riffoser_wave_free(wave1);
	riffoser_track_free(track);
	...
	riffoser_track_writeogg(track,"example8.ogg",48000,256);
	riffoser_wave_free(wave1);
